...
form.querySelector("button").addEventListener("click", ()=>{
    ...
    if (form.elements.name.value && form.elements.position.value && form.elements.office.value && form.elements.age.value && form.elements.salary.value) {
        ...
        const salaryFormatted = parseFloat(form.elements.salary.value.replace(/[^0-9.]/g, ""));
        newRow.insertCell(4).textContent = `$${new Intl.NumberFormat("us-IN").format(salaryFormatted)}`;
